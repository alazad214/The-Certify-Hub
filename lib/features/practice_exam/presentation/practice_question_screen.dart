...
class _PracticeQuestionScreenState extends State<PracticeQuestionScreen> {
  ...
  final List<Map<String, dynamic>> questionData = [
    ...
    {
      "question": "Which is not a database management system?",
      "options": [
        "MySQL",
        "MongoDB",
        "Python",
    ...
    {
      "question": "Which is the smallest unit of digital information?",
      "options": [
        "Byte",
        "Kilobyte",
        "Bit",
    ...
    {
      "question": "Which type of storage is considered volatile?",
      "options": [
        "RAM",
        "SSD",
        "Hard Disk",
